    ...
    >
      <div className="max-w-7xl mx-auto pt-20 pb-8 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          A brief look at how Alpha Circle came together and evolved through thoughtfully curated gatherings.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-[31px] md:left-[31px] w-10 rounded-full bg-white dark:bg-black flex items-center justify-center -translate-x-1/2">
